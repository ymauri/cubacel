                              ...
                              <div class="item-inner ">
                                <div class="js-product-miniature" data-id-product="{$product['id']}" data-id-product-attribute="0" itemscope="">
                                    ...
                                    <form method="post" action="{$link->getPageLink('cart')}" class="recharge text-center">
                                          ...
                                          <input type="number" min="50000000" max="59999999" id="phone-{$product['id']}" class="mb-1 form-control mt-1 text-center" required="required" aria-label="Small" placeholder="Solo 8 dígitos" aria-describedby="inputGroup-sizing-sm">
