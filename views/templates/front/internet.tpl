          ...
          <!--<form method="post" action="#" autocomplete="off">-->
            <div class="row">          
                   {foreach $products as $product}
                      <div class="col-12 col-lg-3 cubacel-product mb-2">
                          <div class="item">
                              <div class="item-inner hover_second_img">
                                <div class="js-product-miniature row" data-id-product="{$product['id']}" data-id-product-attribute="0" itemscope="" itemtype="http://schema.org/Product">
                                    ...
                                    <form method="post" action="{$link->getPageLink('cart')}" class="recharge text-center">
                                          ...
                                          <input type="email" id="email-{$product['id']}" class="mb-2 form-control d-inline mt-1 text-center w-100" required="required" aria-label="Small" placeholder="usuario@nauta.com.cu" aria-describedby="inputGroup-sizing-sm">
                                        <a href="#" class="btn d-inline button-action add-custom w-100" data-id="{$product['id']}" title="Recargar">Recargar</a>
